...
export default function AddElection() {
  ...
  const [type, setType] = useState("public_single_choice");
  ...
  return (
    <div className="grid grid-cols-1 md:gap-4 md:grid-cols-2 overflow-y-auto h-full w-full p-2 md:p-10 bg-white dark:bg-neutral-950">
      <div className="w-full order-1 md:order-1 md:shadow-input md:dark:shadow-neutral-900 border-0 z-20 md:mt-5 md:mx-5 md:max-w-md rounded-2xl p-4 md:p-8">
        ...
        <form className="mt-4 md:my-4">
          ...
          <LabelInputContainer className="mb-4">
            ...
            <Select
              defaultValue="public_single_choice"
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="public_single_choice">
          ...
          <LabelInputContainer className="mb-4 md:mb-4">
          ...
          <LabelInputContainer className="mb-4">
            <Label htmlFor="voterLimit">
              Voter limit <span className="text-neutral-400">(optional)</span>
            </Label>
            <span className="text-neutral-400 text-sm">
              Leave blank or enter 0 for unlimited voters
            </span>
            <Input
              id="voterLimit"
              name="voterLimit"
          ...
          <div className="md:mb-10 flex items-center space-x-2">
            ...
            <label
              ...
              className="text-sm text-neutral-700 dark:text-white"
            >
              Start immediately
            </label>
          </div>
      ...
      <div className="flex flex-col h-full order-4 md:order-3 justify-between  md:shadow-input md:dark:shadow-neutral-900 border-0 z-20 md:mt-5  md:mx-5 w-full md:max-w-md rounded-2xl p-4 md:p-8">
        <div className="mt-2 h-[1px] mb-4 md:mb-10 w-full bg-gradient-to-r from-transparent via-neutral-300 to-transparent dark:via-neutral-700" />
        ...
        {txHash && (
          <div className="p-2 border-1 rounded-xl flex flex-col justify-center text-neutral-400 mb-2">
            <div className="flex flex-row items-center ">
              {!statusData?.confirmed && (
                <>
                  <div className="h-5 w-5 animate-spin rounded-full border-2 border-blue-500 border-t-transparent" />
                  <p className="ml-2 align-center">
                    Election is being created...
                  </p>
                </>
              )}
              {statusData?.confirmed && (
                <p className="ml-2 align-center">
                  🎉 Election created with ID: {statusData.electionId}
                </p>
              )}
            </div>
        ...
        <div>
          <button
            className={cn(
              "group/btn relative block h-10 w-full cursor-pointer rounded-md bg-gradient-to-br from-black to-neutral-600 font-medium text-white shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:bg-zinc-800 dark:from-zinc-900 dark:to-zinc-900 dark:shadow-[0px_1px_0px_0px_#27272a_inset,0px_-1px_0px_0px_#27272a_inset]",
              {
          ...
          <div className="mt-2 h-[1px] w-full bg-gradient-to-r from-transparent via-neutral-300 to-transparent dark:via-neutral-700" />
        </div>
      </div>
        ...
        <div>
          ...
          <div className="">
            <button
              className={cn(
                "group/btn relative block h-10 w-full cursor-pointer rounded-md bg-gradient-to-br from-black to-neutral-600 font-medium text-white shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:bg-zinc-800 dark:from-zinc-900 dark:to-zinc-900 dark:shadow-[0px_1px_0px_0px_#27272a_inset,0px_-1px_0px_0px_#27272a_inset]",
                addCandidateLoading && "opacity-50 cursor-not-allowed"
              )}
